...
INSERT INTO usuarios (nome_usuario, email, senha, papel)
VALUES 
...
INSERT INTO professores (usuario_id, nome_completo, email)
VALUES
  (
    (SELECT id FROM usuarios WHERE email = 'maria.prof@escola.com'),
...
INSERT INTO alunos (usuario_id, nome_completo, email, serie, turma)
VALUES
  (
    (SELECT id FROM usuarios WHERE email = 'ana.clara@escola.com'),
    'Ana Clara Souza',
  ...
  (
    (SELECT id FROM usuarios WHERE email = 'bruno.lima@escola.com'),
    'Bruno Henrique Lima',
  ...
  (
    (SELECT id FROM usuarios WHERE email = 'carla.pereira@escola.com'),
...
INSERT INTO pedidos_diagnostico (professor_id, titulo, descricao, serie, turma, status)
VALUES
  (
    (SELECT id FROM professores WHERE email = 'maria.prof@escola.com'),
...
VALUES
  (
    (SELECT id FROM pedidos_diagnostico WHERE titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre' LIMIT 1),
    (SELECT id FROM alunos WHERE email = 'ana.clara@escola.com')
  ),
  (
    (SELECT id FROM pedidos_diagnostico WHERE titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre' LIMIT 1),
    (SELECT id FROM alunos WHERE email = 'bruno.lima@escola.com')
  ),
  (
    (SELECT id FROM pedidos_diagnostico WHERE titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre' LIMIT 1),
    (SELECT id FROM alunos WHERE email = 'carla.pereira@escola.com')
  )
...
VALUES
  (
    (SELECT r.id FROM respostas_diagnostico r 
     ...
     JOIN pedidos_diagnostico p ON r.pedido_id = p.id 
     WHERE a.email = 'ana.clara@escola.com' AND p.titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre'),
  ...
  (
    (SELECT r.id FROM respostas_diagnostico r 
     JOIN alunos a ON r.aluno_id = a.id 
     JOIN pedidos_diagnostico p ON r.pedido_id = p.id 
     WHERE a.email = 'bruno.lima@escola.com' AND p.titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre'),
  ...
  (
    (SELECT r.id FROM respostas_diagnostico r 
     JOIN alunos a ON r.aluno_id = a.id 
     JOIN pedidos_diagnostico p ON r.pedido_id = p.id 
     WHERE a.email = 'carla.pereira@escola.com' AND p.titulo = 'Diagnóstico Inicial 2026 - 1º Bimestre'),
