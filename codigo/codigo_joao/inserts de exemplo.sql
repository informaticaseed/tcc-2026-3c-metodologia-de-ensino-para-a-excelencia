...
-- 1) Alunos
INSERT INTO alunos (id, nome_completo, email, serie, turma)
VALUES
  (1, 'Ana Clara Souza', 'ana.clara@example.com', '8º ano', 'A'),
  (2, 'Bruno Henrique Lima', 'bruno.lima@example.com', '9º ano', 'B'),
  (3, 'Carla Mendes Pereira', 'carla.pereira@example.com', '1º ano EM', 'C');
